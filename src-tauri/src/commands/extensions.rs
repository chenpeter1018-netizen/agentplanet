...
cd /tmp
echo "下载 cftunnel..."
curl -fsSL https://raw.githubusercontent.com/Agent Planet Systems/cftunnel/main/install.sh -o cftunnel-install.sh
...
Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/Agent Planet Systems/cftunnel/main/install.ps1' -OutFile $tmp -UseBasicParsing
Write-Output '执行安装脚本...'
& $tmp
...
curl -fsSL https://raw.githubusercontent.com/Agent Planet Systems/clawapp/main/install.sh | bash
echo "安装完成"
"#;
        Command::new("bash")
            .arg("-c")
...
Write-Output '下载安装脚本到临时文件...'
Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/Agent Planet Systems/clawapp/main/install.ps1' -OutFile $tmp -UseBasicParsing
Write-Output '执行安装脚本...'
& $tmp -Auto
Remove-Item $tmp -ErrorAction SilentlyContinue
Write-Output '安装完成'

...
export function render() {
  ...
  // --- Event binding ---
  function bind() {
    el.querySelector('.zc-logs-refresh')?.addEventListener('click', () => loadEntries())
    el.querySelector('.zc-logs-tail')?.addEventListener('click', toggleTail)
    el.querySelector('.zc-logs-download')?.addEventListener('click', doDownload)
    el.querySelector('.zc-logs-clear')?.addEventListener('click', doClearView)

    el.querySelectorAll('.zc-logs-file-item').forEach(item => {

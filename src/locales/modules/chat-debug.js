...
export default {
  ...
  diagGatewayNotRunning: _('Gateway 未启动，请前往「引擎管理」页面启动服务', 'Gateway not running, please go to Engines page to start', 'Gateway 未啟動，請前往「引擎管理」頁面啟動服務'),
  ...
  fixSuggestManualRestart: _('建议：请手动前往「引擎管理」页面重启 Gateway', 'Suggestion: Manually restart Gateway from Engines page', '建議：請手動前往「引擎管理」頁面重啟 Gateway', '「エンジン管理」ページで Gateway を手動で再起動してください'),

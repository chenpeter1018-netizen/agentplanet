...
export default {
  ...
  markdownTitle: _('Markdown 渲染', 'Markdown Rendering'),
  markdownHint: _('在回答消息的时候使用富文本更直观展示回答如：标题、加粗、列表、表格、代码块这些排版，全靠 Markdown 符号实现。', 'Use rich text in replies for formatting: headings, bold, lists, tables, code blocks — all powered by Markdown syntax.'),
  markdownEnabled: _('已开启 Markdown 渲染', 'Markdown rendering enabled'),
  markdownDisabled: _('已关闭 Markdown 渲染', 'Markdown rendering disabled'),
}

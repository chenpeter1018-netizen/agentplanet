...
export default {
  title: _('员工管理', 'Employee Management'),
  desc: _('添加和管理你的数字员工，记得给员工配置身份、模型和工作区', 'Add and manage your digital employees. Configure their identity, model and workspace.'),
  addAgent: _('+ 添加员工', '+ Add Employee'),
  ...
  agentEmoji: _('头像', 'Avatar'),
  agentEmojiPlaceholder: _('输入 emoji 或图片路径作为头像', 'Enter emoji or image path for avatar'),
  backToList: _('返回员工管理', 'Back to Employee Management'),
  employeeMarket: _('员工市场', 'Employee Market'),
  marketHint: _('选择一个数字员工加入你的团队，他们将协助完成各类专业任务。', 'Select a digital employee to join your team.'),
  addToTeam: _('加入团队', 'Add to Team'),
  adding: _('添加中...', 'Adding...'),
  added: _('已加入', 'Added'),
  addSuccess: _('已加入你的团队', 'added to your team'),
  ...
  openWorkspace: _('工作文件夹', 'Workspace', '工作資料夾'),
  noWorkspace: _('未设置工作区路径', 'No workspace path configured', '未設定工作區路徑'),
  openWorkspaceFailed: _('打开工作文件夹失败', 'Failed to open workspace', '打開工作資料夾失敗'),

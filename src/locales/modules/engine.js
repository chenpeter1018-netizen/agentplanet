...
export default {
  ...
  gatewayDesc: _('启动 HTTP API 服务以连接 Agent Planet', 'Start HTTP API server to connect with Agent Planet', '啟動 HTTP API 服務以連接 Agent Planet'),
  ...
  dashNativePanelWindowsAlt1: _('继续使用 Agent Planet 内置的 Hermes 面板（推荐，体验更好）',
    'Keep using Agent Planet\'s built-in Hermes panel (recommended, better experience)',
    '繼續使用 Agent Planet 內建的 Hermes 面板（推薦，體驗更好）',
    'Agent Planet 内蔵の Hermes パネルを使い続ける（推奨、より良い体験）',
    'Agent Planet 내장 Hermes 패널을 계속 사용 (권장, 더 나은 경험)'),
  ...
  installNow: _('立即安装', 'Install Now', '立即安裝'),
  installing: _('安装中...', 'Installing...', '安裝中...'),
  installDone: _('安装完成', 'Installation complete', '安裝完成'),
  serviceStarted: _('服务已启动', 'Service started', '服務已啟動'),
  serviceStopped: _('服务已停止', 'Service stopped', '服務已停止'),
  serviceRestarted: _('服务已重启', 'Service restarted', '服務已重啟'),
  healthOk: _('健康检查通过', 'Health check passed', '健康檢查通過'),
  healthFail: _('健康检查未通过', 'Health check failed', '健康檢查未通過'),
  ...
  portOpen: _('端口已开放', 'Port is open', '端口已開放'),
  portClosed: _('端口未开放', 'Port is closed', '端口未開放'),
  serviceRunning: _('服务运行中', 'Service is running', '服務運行中'),
  probePort: _('探测端口', 'Probe Port', '探測端口'),
}

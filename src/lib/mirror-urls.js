...
const GITHUB_ORG = 'https://github.com/Agent Planet Systems'
const GITEE_ORG = 'https://gitee.com/QtCodeCreators'
const GITHUB_RAW = 'https://raw.githubusercontent.com/Agent Planet Systems'
const GITEE_RAW = 'https://gitee.com/QtCodeCreators'

// 仓库名映射（GitHub → Gitee，名称不同时需映射）
const REPO_MAP = {
  agent-planet: 'agent-planet',
  clawapp: 'clawapp',
  cftunnel: 'cftunnel',
 ...
 * @param {string} repo - 仓库名，如 'agent-planet'
...
export function deployCommand() {
  return {
    github: `curl -fsSL ${GITHUB_RAW}/agent-planet/main/deploy.sh | bash`,
    gitee: `curl -fsSL ${GITEE_RAW}/agent-planet/raw/main/deploy.sh | bash`,
  }
}

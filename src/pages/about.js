...
export async function render() {
  ...
  page.innerHTML = `
    <div class="page-header" style="display:flex;align-items:center;gap:16px">
      <img src="/images/logo-brand.png" alt="Agent Planet" style="height:48px;width:auto">
      <div>
        <h1 class="page-title" style="margin:0">Agent Planet</h1>
  ...
  if (activeEngineId === 'xintian') {
    // ZeroClaw 是产品宣传入口，不展示 OpenClaw/Hermes 的版本、安装路径与社群信息
...
/**
 * ZeroClaw 模式下的 about 页面：只展示 Agent Planet 自身版本 + 产品卡片，
...
async function loadXintianData(page) {
  ...
  cards.innerHTML = `
    <div class="stat-card">
      <div class="stat-card-header"><span class="stat-card-label">Agent Planet</span></div>
    ...
    <div class="stat-card">
      <div class="stat-card-header"><span class="stat-card-label">ZeroClaw</span></div>
...
async function loadData(page) {
  ...
  try {
    ...
    // 尝试从 Tauri API 获取 Agent Planet 自身版本号，失败则 fallback
    const panelVersion = typeof __APP_VERSION__ !== 'undefined' ? __APP_VERSION__ : '0.1.0'
  ...
  try {
    ...
    if (isFakeUpdate) {
      meta.innerHTML = `
        ...
        <a class="btn btn-secondary btn-sm" href="${info.url || 'https://github.com/Agent Planet Systems/agent-planet/releases'}" target="_blank" rel="noopener" style="${btnSm}">${t('about.downloadFromGitHub')}</a>
      `
...
const PROJECTS = [
  ...
  {
    name: 'Agent Planet',
    desc: t('about.projectAgent Planet'),
    url: 'https://github.com/Agent Planet Systems/agent-planet',
    gitee: 'https://gitee.com/QtCodeCreators/agent-planet',
  },
  {
    name: 'ClawApp',
    desc: t('about.projectClawApp'),
    url: 'https://github.com/Agent Planet Systems/clawapp',
  },
  {
    name: 'cftunnel',
    desc: t('about.projectCftunnel'),
    url: 'https://github.com/Agent Planet Systems/cftunnel',
  },
]
...
function renderContribute(page) {
  ...
  el.innerHTML = `
    ...
    <div style="display:flex;flex-wrap:wrap;gap:8px">
      <a class="btn btn-primary btn-sm" href="https://github.com/Agent Planet Systems/agent-planet/issues/new" target="_blank" rel="noopener">${t('about.submitIssue')}</a>
      <a class="btn btn-secondary btn-sm" href="https://github.com/Agent Planet Systems/agent-planet/pulls" target="_blank" rel="noopener">${t('about.submitPR')}</a>
      <a class="btn btn-secondary btn-sm" href="https://github.com/Agent Planet Systems/agent-planet/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener">${t('about.contributeGuide')}</a>
      <a class="btn btn-secondary btn-sm" href="https://github.com/Agent Planet Systems/agent-planet/issues" target="_blank" rel="noopener">${t('about.viewIssues')}</a>
    </div>
    ...
    <div style="display:flex;flex-direction:column;gap:12px">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:12px;font-size:var(--font-size-sm)">
        <div style="padding:12px;border-radius:var(--radius-md);border:1px solid var(--border-primary);background:var(--bg-secondary)">
          ...
          <a href="https://Agent Planet Systems.com" target="_blank" rel="noopener" style="color:var(--accent)">Agent Planet Systems.com</a>
        </div>
        <div style="padding:12px;border-radius:var(--radius-md);border:1px solid var(--border-primary);background:var(--bg-secondary)">
        ...
        <div style="padding:12px;border-radius:var(--radius-md);border:1px solid var(--border-primary);background:var(--bg-secondary)">
          ...
          <a href="https://github.com/Agent Planet Systems" target="_blank" rel="noopener" style="color:var(--accent)">github.com/Agent Planet Systems</a>
        </div>
        <div style="padding:12px;border-radius:var(--radius-md);border:1px solid var(--border-primary);background:var(--bg-secondary)">

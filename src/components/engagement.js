...
const KEYS = {
  firstOpen: 'agent_planet_first_open',
  openCount: 'agent_planet_open_count',
  lastShown: 'agent_planet_engage_shown',
  never: 'agent_planet_engage_never',
  todayDismiss: 'agent_planet_engage_today',
}
  ...
  overlay.innerHTML = `
    <div class="engage-modal">
      ...
      <div class="engage-actions-grid">
        <a class="engage-action-card" href="https://github.com/Agent Planet Systems/agent-planet" target="_blank" rel="noopener">

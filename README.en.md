...
<p align="center">
  <img src="docs/feature-showcase.gif" width="800" alt="Agent Planet Feature Showcase">
</p>

Agent Planet is a visual management panel supporting multiple AI Agent frameworks, currently with [OpenClaw](https://github.com/1186258278/OpenClawChineseTranslation) and [Hermes Agent](https://github.com/nousresearch/hermes-agent) dual-engine support. It features a **built-in intelligent AI assistant** that helps you install, auto-diagnose configurations, troubleshoot issues, and fix errors. 8 tools + 4 modes + interactive Q&A — easy to manage for beginners and experts alike.

> 🌐 **Website**: [claw.qt.cool](https://claw.qt.cool/) | 📦 **Download**: [GitHub Releases](https://github.com/Agent Planet Systems/agent-planet/releases/latest)
...
Agent Planet provides a **pure Web deployment mode** (zero GUI dependency), natively compatible with ARM64 boards:

- **Orange Pi / Raspberry Pi / RK3588** — `npm run serve` to run
- **Docker ARM64** — `docker run ghcr.io/Agent Planet Systems/openclaw:latest`
...
<p align="center">
  ...
  &nbsp;·&nbsp;
  <a href="https://github.com/Agent Planet Systems/agent-planet/issues/new"><strong>Report Issue</strong></a>
</p>
...
Go to [Releases](https://github.com/Agent Planet Systems/agent-planet/releases/latest) for the latest version:

### macOS

| Chip | Installer | Notes |
|------|-----------|-------|
| Apple Silicon (M1/M2/M3/M4) | `Agent Planet_x.x.x_aarch64.dmg` | Macs from late 2020+ |
| Intel | `Agent Planet_x.x.x_x64.dmg` | Macs 2020 and earlier |

> **⚠️ "Damaged" or "unverified developer"?** App is unsigned. Run: `sudo xattr -rd com.apple.quarantine /Applications/Agent Planet.app`

### Windows

| Format | Installer | Notes |
|--------|-----------|-------|
| EXE | `Agent Planet_x.x.x_x64-setup.exe` | Recommended |
| MSI | `Agent Planet_x.x.x_x64_en-US.msi` | Enterprise / silent install |

### Linux

| Format | Installer | Notes |
|--------|-----------|-------|
| AppImage | `Agent Planet_x.x.x_amd64.AppImage` | No install, `chmod +x` and run |
| DEB | `Agent Planet_x.x.x_amd64.deb` | `sudo dpkg -i *.deb` |
| RPM | `Agent Planet-x.x.x-1.x86_64.rpm` | `sudo rpm -i *.rpm` |
...
Agent Planet desktop supports frontend hot updates. Update files are stored at:
...
After restarting Agent Planet, the built-in frontend resources will be used automatically.
...
| [ClawApp](https://github.com/Agent Planet Systems/clawapp) | Cross-platform mobile chat client |
| [cftunnel](https://github.com/Agent Planet Systems/cftunnel) | Cloudflare Tunnel tool |
...
Agent Planet keeps growing because of every contributor in the community. Thank you for helping make the project better.
...
<table>
  <tr>
    <td align="center"><a href="https://github.com/liucong2013"><img src="https://github.com/liucong2013.png?size=80" width="60" height="60"><br><sub><b>liucong2013</b></sub></a><br><a href="https://github.com/Agent Planet Systems/agent-planet/pull/88">#88</a></td>
    <td align="center"><a href="https://github.com/axdlee"><img src="https://github.com/axdlee.png?size=80" width="60" height="60"><br><sub><b>axdlee</b></sub></a><br><a href="https://github.com/Agent Planet Systems/agent-planet/pull/58">#58</a></td>
    <td align="center"><a href="https://github.com/ATGCS"><img src="https://github.com/ATGCS.png?size=80" width="60" height="60"><br><sub><b>ATGCS</b></sub></a><br><a href="https://github.com/Agent Planet Systems/agent-planet/pull/107">#107</a></td>
    <td align="center"><a href="https://github.com/livisun"><img src="https://github.com/livisun.png?size=80" width="60" height="60"><br><sub><b>livisun</b></sub></a><br><a href="https://github.com/Agent Planet Systems/agent-planet/pull/106">#106</a></td>
    <td align="center"><a href="https://github.com/kiss-kedaya"><img src="https://github.com/kiss-kedaya.png?size=80" width="60" height="60"><br><sub><b>kiss-kedaya</b></sub></a><br><a href="https://github.com/Agent Planet Systems/agent-planet/pull/101">#101</a> <a href="https://github.com/Agent Planet Systems/agent-planet/pull/94">#94</a></td>
    <td align="center"><a href="https://github.com/wzh4869"><img src="https://github.com/wzh4869.png?size=80" width="60" height="60"><br><sub><b>wzh4869</b></sub></a><br><a href="https://github.com/Agent Planet Systems/agent-planet/pull/82">#82</a></td>
    <td align="center"><a href="https://github.com/0xsline"><img src="https://github.com/0xsline.png?size=80" width="60" height="60"><br><sub><b>0xsline</b></sub></a><br><a href="https://github.com/Agent Planet Systems/agent-planet/pull/15">#15</a></td>
    <td align="center"><a href="https://github.com/jonntd"><img src="https://github.com/jonntd.png?size=80" width="60" height="60"><br><sub><b>jonntd</b></sub></a><br><a href="https://github.com/Agent Planet Systems/agent-planet/pull/18">#18</a></td>
  </tr>
</table>
...
> If we missed your contribution, please [open an issue](https://github.com/Agent Planet Systems/agent-planet/issues/new) and we will add it promptly.
...
- **Website**: [Agent Planet Systems.com](https://Agent Planet Systems.com)
